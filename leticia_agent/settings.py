...
# ---- Robinhood (lead source) ----
ROBINHOOD_SUPABASE_URL = env("ROBINHOOD_SUPABASE_URL", "https://gtyvhuxlwempbxzdtfdh.supabase.co")
ROBINHOOD_SUPABASE_ANON_KEY = env("ROBINHOOD_SUPABASE_ANON_KEY")
ROBINHOOD_EMAIL = env("ROBINHOOD_EMAIL")
ROBINHOOD_PASSWORD = env("ROBINHOOD_PASSWORD")

# ---- Media (transcription + vision) ----
GROQ_API_KEY = env("GROQ_API_KEY", "")  # Whisper transcription (free tier)
